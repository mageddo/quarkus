...
/**
 * Tests a cache with an <b>implicit</b> name and <b>explicit simple</b> cache keys.<br>
 * All methods with a {@link CacheKey @CacheKey}-annotated argument also have another argument which is not part of the key.
 */
public class ImplicitNameExplicitSimpleKeyCacheTest {
    ...
    public void testAllCacheAnnotations() {
        ...
        String value1 = cachedService.load(KEY_1, new Object());
        ...
        // instance.
        String value4 = cachedService.store(KEY_1, new Object());
        ...
        String value5 = cachedService.store(KEY_1, new Object());
        ...
        String value6 = cachedService.load(KEY_1, new Object());
        assertEquals(2, cachedService.getLoadInvocations());
        ...
        String value8 = cachedService.load(KEY_1, new Object());
        ...
        String value9 = cachedService.load(KEY_2, new Object());
        assertEquals(3, cachedService.getLoadInvocations());
        ...
        String value11 = cachedService.load(KEY_1, new Object());
        ...
        String value12 = cachedService.load(KEY_2, new Object());
    ...
    static class CachedService {
        ...
        @CacheLoad
        public String load(@CacheKey long key, Object notPartOfTheKey) {
            loadInvocations++;
            return new String();
        }

        @CacheStore
        public String store(@CacheKey long key, Object notPartOfTheKey) {
            storeInvocations++;
            return new String();
        }
