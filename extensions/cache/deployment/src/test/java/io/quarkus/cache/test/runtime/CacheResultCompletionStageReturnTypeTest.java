...
public class CacheResultCompletionStageReturnTypeTest {
    ...
    public void testAllCacheAnnotations() throws InterruptedException, ExecutionException {
        ...
        // Objects references resulting from STEPS 1 and 2 should be equal since the same cache key was used. 
        assertTrue(value1 == value2);

        // Objects references resulting from STEPS 2 and 3 should be different since a different cache key was used. 
